...
```{r echo=FALSE, message=FALSE, warning=FALSE, comment='', fig.width=6, fig.height=3, dev='svg'}
bwg_main_chart_facet
```

```{r echo=FALSE, message=FALSE, warning=FALSE, comment='', fig.width=4, fig.height=4, dev='svg'}
bwg_main_chart_all   
```
